...
<<<<<<< HEAD
:::{.proposition #flow-unique}
设 $\theta_1,\theta_2$ 是两个从 $a$ 到 $Z$ 的流且满足 $\|\theta_1\| = \|\theta_2\|$，则 $\theta_1=\theta_2$。
:::
...
>>>>>>> b2854932b6c721fd7383e7c68ae3f7998c450fd1
...
:::{.definition}
<<<<<<< HEAD
设 $h:V\to\mathbb{R}$ 是实值函数，$h(a)=\alpha,\,h|_Z\equiv \beta$，且 $h$ 在任何 $x\notin \{a\}\cup Z$ 处调和。则我们称 $h$ 是一个**电势**函数。$\alpha,\beta$ 是边界条件。
=======
...
<<<<<<< HEAD
为了证明 $\mathcal{E}(i)=\Reff$，我们考虑 @Pre:unit-flow-by-green 中的电势 $v$，则 $i=\nabla v$。
