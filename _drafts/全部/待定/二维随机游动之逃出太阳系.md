...
$$\begin{aligned}\int_0^{\pi/2}\mathrm{d}\alpha\int_{x\sin\alpha}^{x}\frac{\cos u}{u}\,\mathrm{d}u&=\int_0^{\pi/2}\mathrm{d}\alpha\int_{\sin\alpha}^1\frac{\cos zx}{z}\,\mathrm{d}z\\&=\int_0^1\mathrm{d}z\int_0^{\arcsin z}\frac{\cos zx}{z}\,\mathrm{d}\alpha\\&=\int_0^1\frac{\arcsin z}{z}\cos zx\,\mathrm{d}z.\end{aligned}$$
