...
这里真正的秘密在于一种叫做 [复共轭](https://en.wikipedia.org/wiki/Complex_conjugate) 的东西。一个复表示 $V$ 能“回到”实数世界，当且仅当在 $V$ 上存在一个 [共轭线性](https://en.wikipedia.org/wiki/Antilinear_map) 的变换 $J\colon\ V\to V$，它满足两个条件：
