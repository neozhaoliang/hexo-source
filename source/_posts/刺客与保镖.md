...
由于光路的可逆性，这个话也可以反过来说，即虚像房间中的一点可能来自真实房间中若干个不同的实际位置。后文会证明这样的位置最多有 6 种不同的可能。对平面上一个二维格点，按照刺客和格点之间的连线折叠回真实房间，最终的实际位置有多达 6 种可能。所以保镖数目要乘以 6，即总共需要 4 x 6 x 6 = 144 名保镖。
